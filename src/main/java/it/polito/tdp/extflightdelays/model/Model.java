...
public class Model {
	...
	//i vertici sono degli aeroporti---> idMap
	...
	//Metodo per creare il grafo---> dobbiamo filtrare i Vertici dobbiamo passare il filtro
	public void creaGrafo(int x) {
		this.grafo = new SimpleWeightedGraph<>(DefaultWeightedEdge.class);
		
		//aggiungiamo i vertici rispettando il vincolo
	...
	public List<Airport> trovaPercorso(Airport a1, Airport a2){
		...
		//tenere traccia dell'albero di visita
